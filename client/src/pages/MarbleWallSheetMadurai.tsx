          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex items-center justify-center gap-2 text-sm text-cool-grey">
                ...
                <span>Serving all areas of Madurai • Fast response • Free consultation</span>
              </div>
            </div>
          </div>
        </section>
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-12">
                  ...
                  <div className="bg-light-silver/30/50 rounded-lg overflow-hidden">
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-cool-grey text-sm">Premium choice</p>
                    </div>
                  </div>
                  <div className="bg-light-silver/30/50 rounded-lg overflow-hidden">
                    <img
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-cool-grey text-sm">Natural appeal</p>
                    </div>
                  </div>
                </div>
