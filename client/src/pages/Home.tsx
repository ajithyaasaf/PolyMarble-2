  ...
  return (
    <div className="relative min-h-screen bg-pure-white text-deep-charcoal overflow-hidden">
      ...
      <main className="scroll-smooth relative z-10">
        ...
        <div className="section-spacing bg-warm-cream !pb-0">
          <Gallery3D />
        </div>

        {/* Customer Gallery Preview CTA */}
        <div className="section-spacing bg-gradient-to-br from-pure-white via-warm-cream to-pure-white relative overflow-hidden !pt-0">
