              ...
              <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-gradient-to-r from-metallic-gold/20 to-metallic-gold/10 rounded-lg p-8 text-center border border-metallic-gold/30">
                  ...
                  <p className="text-cool-grey mb-6 text-lg">
                    Our Chennai-based engineering team provides free structural assessments and comprehensive solutions
                  ...
                  <div className="grid md:grid-cols-3 gap-4 mb-8 text-sm">
                    ...
                    <div className="bg-warm-cream/30 rounded-lg p-4">
                      <div className="font-bold text-metallic-gold">Project Design</div>
                      <div className="text-cool-grey">Standardized to high specifications</div>
                    </div>
                    <div className="bg-warm-cream/30 rounded-lg p-4">
