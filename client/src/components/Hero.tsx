          ...
          <div className="lg:col-span-7 space-y-5 sm:space-y-8">
            ...
            <div className="inline-flex items-center group">
              <div className="flex items-center gap-2 sm:gap-3 px-3 sm:px-5 py-2 sm:py-2.5 bg-gradient-to-r from-brand-teal/10 to-brand-peach/10 border border-brand-teal/20 rounded-full backdrop-blur-sm reveal-scale">
                ...
                <span className="text-xs sm:text-sm font-semibold text-deep-charcoal">
            ...
            <div className="space-y-3 sm:space-y-4">
              <h1 className="reveal-up">
                ...
                <span className="block text-4xl sm:text-6xl lg:text-8xl font-black leading-none mt-1 sm:mt-2">
            ...
            <div className="space-y-2 sm:space-y-3 reveal-fade">
              <p className="text-base sm:text-xl text-deep-charcoal/80 font-medium leading-relaxed">
                ...
                {["Fire Resistant", "Waterproof", "15+ Years Warranty"].map(
                  (feature, i) => (
                    ...
                    >
                      ...
                      <span className="text-xs sm:text-sm font-medium text-deep-charcoal whitespace-nowrap">
                        {feature}
                      </span>
                    </div>
                  ),
