      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            {/* Newsletter Signup */}
            <div className="mb-6">
              <h6 className="text-brand-teal font-medium mb-3">
              ...
              <p className="text-xs text-cool-grey">
                Get our 12-page Guide: How to Choose the Perfect Polymarble
                Finish.
              </p>
            </div>
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2 text-cool-grey">
                ...
                <span>
                  No:46, Sivagangai Main Road, Melamadai, Gomathipuram, Madurai
                  - 625020
                </span>
              </div>
              <div className="flex items-center gap-2 text-cool-grey">
        ...
        {/* Footer Bottom */}
        <div className="border-t border-light-silver mt-8 pt-8 text-center space-y-2">
          <div className="text-sm text-cool-grey">
            © 2025 Polymarble Sheet India. All rights reserved. | Chennai
            Office: Dr. Kannan Tower, Arcot Road, Opp to Naidu Hall, Porur - 116
          </div>
