...
            {/* The change is here: h-10 removed, py-2 added for flexible spacing */}
            <div className="grid grid-cols-[1fr_auto] sm:grid-cols-[max-content_1fr_max-content] items-center w-full gap-2 sm:gap-4 **py-2** text-xs">
