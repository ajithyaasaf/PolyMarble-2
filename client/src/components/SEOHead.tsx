...
export default function SEOHead({
  ...
  description = "Transform your spaces with premium polymarble sheets. 80% less cost than natural marble. Fire-resistant, water-proof, 15+ year durability. Serving Tamil Nadu since 2017.",
